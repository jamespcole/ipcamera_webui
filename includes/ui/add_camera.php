<script id="add_camera-template" type="text/x-handlebars-template">
    <div class="row col-sm-offset-1 col-sm-10 camera-settings">
		...
		<form role="form" class="form-horizontal" id="configuration_form">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-md-7 col-sm-10">
					<div class="row">
						...
						<div class="col-xs-4">
							<a class="btn btn-info pull-right" id="test_config_btn">Test Settings</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group" style="display:none" id="configuration_test_output">
				<div class="col-md-9 col-sm-12">
					...
					<div class="alert alert-danger">
						...
						<div class="row">
							<p class="col-xs-9 col-sm-9">Your camera could not be found.  Please ensure that all settings are correct.</p>
							<p class="col-xs-3 col-sm-3"><a class="btn btn-danger pull-right test-config-btn">Try Again</a></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-9 col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<p>
								<a class="btn btn-success add-command pull-right col-xs-12 col-sm-4"><span class="glyphicon glyphicon-plus-sign"></span> Add Camera Command</a>
							</p>
						</div>
						<table class="table sortable-table" id="commands_table" style="display:none">
							<thead>
								<tr>
									<th>Name</th>
			...
			<div class="form-group advanced-camera-option">
				<div class="col-md-9 col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>
								You can retrieve status information about your camera which you can display
								or use in your camera commands.
								Click the "Add Status Parser" button to add a new parser
							</p>
							<p>
								<a class="btn btn-success add-status-parser pull-right col-xs-12 col-sm-4"><span class="glyphicon glyphicon-plus-sign"></span> Add Status Parser</a>
							</p>
						</div>
						<table class="table sortable-table" id="status_parsers_table" style="display:none">
							<thead>
								<tr>
									<th>Url</th>
									<th><span class="pull-right">Actions</span></th>
			...
			<div class="form-group">
				<div class="col-md-9 col-sm-12">
					...
					<a href="settings" class="btn btn-default">Cancel</a>
				</div>
			</div>
		</form>
	</div>

		...
		{{#unless cameras.length}}
			<div class="jumbotron">
				...
				<p>
					...
					<a class="btn btn-lg btn-primary check-btn" role="button" href="add_motion_server"><span class="glyphicon glyphicon-cloud-download"></span> Import Cameras from Motion</a>
				</p>
			</div>
		{{/unless}}
		{{#each cameras}}
